 ...
 * @author HeYQ
 */
@ConfigurationProperties(MongoDbVectorStoreProperties.CONFIG_PREFIX)
public class MongoDbVectorStoreProperties extends CommonVectorStoreProperties {
	...
	public Float getDefaultSimilarityThreshold() {
		return defaultSimilarityThreshold;
	}

	public void setDefaultSimilarityThreshold(Float defaultSimilarityThreshold) {
		this.defaultSimilarityThreshold = defaultSimilarityThreshold;
	}

	public Map<String, Object> toMongoDbClientParams() {
