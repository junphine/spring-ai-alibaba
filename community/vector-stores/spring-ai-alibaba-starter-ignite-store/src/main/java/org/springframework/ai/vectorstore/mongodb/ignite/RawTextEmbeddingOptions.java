...
public class RawTextEmbeddingOptions implements EmbeddingOptions {
	...
	public static class Builder {
		...
		protected RawTextEmbeddingOptions options;

		public Builder() {
			this.options = new RawTextEmbeddingOptions();
		}
		...
		public RawTextEmbeddingOptions build() {
			return this.options;
		}
